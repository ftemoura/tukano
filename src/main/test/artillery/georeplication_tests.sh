...
do 
    ...
    az container exec --resource-group $RESOURCE_GROUP --name $ACR_NAME$region --exec-command "dig astukano6004560174.trafficmanager.net" > ./reports/dig_$region.json
    az container exec --resource-group $RESOURCE_GROUP --name $ACR_NAME$region --exec-command "dig cosmostukano6004560174.documents.azure.com" > ./reports/dig2_$region.json
